...
from NEM import *
from TI import *
from probcombine_entropy3 import *
import heapq
...
def Pythia(m, template_h, template_x, template_y, lag, lag_h, lag_x, lag_y, N, U, hardlist, code, valuels, scale, epoch,
    ...
    m = np.load('./output/overmodel3.npy')
    ...
    for ni in range(len(scale)):
        ...
        path = "./output2/reconstruction.npy"
        np.save(path, m)
        time_end = time.time()
        ...
        write_data(grid, './output2/output.vtk')
